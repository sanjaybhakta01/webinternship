...
exit(); }
		...
		$ins_query="INSERT INTO skillref(masterjob,skillset,rating)values('$masterjob','$skillset','$rating')";
...
<?php
				...
				$count=1;
				//DUPLICATE MODULES
				$sel_query="Select * from skillref ORDER BY masterjob;";
		...
		$sel_query2="Select * from skillref ORDER BY masterjob;";
		...
		<td align="center">
		<a href="deleteref2.php?skillset=<?php echo $row["skillset"]; ?>&masterjob=<?php echo $row["masterjob"]; ?>">Delete</a></td>
		</font>
		</td></tr>
		<?php $count++;} ?>
		</tbody>
		...
		<?php 
				$con = mysqli_connect("localhost","root","","portal");
				 ...
				 die();
				        ...
				        $result = $con->query("SELECT  skillset from skill order by module");
